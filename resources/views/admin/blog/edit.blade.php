                    ...
                    <form action="{{ route('blog.update', $blog->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="form-group">
                                    ...
                                    <select name="kategori" id="kategoriSelect" class="form-control" required>
                                        ...
                                        <option value="{{ $ktg->id }}" {{$blog->kategori_id == $ktg->id ? 'selected' : ''}}>{{ $ktg->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="custom-file-container" data-upload-id="myFirstImage">
                            ...
                            <label class="custom-file-container__custom-file" >
                                <input type="file" name="gambar" value="{{ File::get(public_path('images\1683822228.jpg')) }}" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
