                        ...
                        <table id="default-ordering" class="table style-3 table-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>Tiger Nixon</td>
                                    <td>
                                        <span><img src="{{ asset('dashboard/assets/img/dinses/sinjai.png')}}" class="profile-img" alt="avatar"></span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <span class="shadow-none badge badge-warning">Not Published</span>
                                    </td>
