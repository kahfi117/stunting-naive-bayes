            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form method="POST" action="{{ route('proses.login') }}" class="text-left needs-validation">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="email" type="email" class="form-control" placeholder="enjoyyourday@happy.com">
                                </div>
