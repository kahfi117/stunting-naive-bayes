            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="footer-widget about-company-widget mb-40 wow fadeInDown">
                        <a href="index.html" class="footer-logo"><img src="user/assets/images/logo/logo-white.png" alt="Brand Logo"></a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="copyright-text">
                        <P>&copy; 2023 <span style="color:#F7921E;">Sistem Informasi 2017</span>, All Rights Reserved</P>
                    </div>
                </div>
            </div>
        </div>
