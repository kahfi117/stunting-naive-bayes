...
<html lang="zxx">
    ...
    <body>
            ...
            <div class="hero-wrapper-one p-r z-1">
                ...
                <div class="hero-slider-one">
                    ...
                    <div class="single-slider p-r z-1" data-title="Camping">
                        <div class="image-layer bg_cover" style="background-image: url(user/assets/images/hero/hero-slider-one.jpg);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                    ...
                    <div class="single-slider p-r z-1" data-title="Adventure">
                        <div class="image-layer bg_cover" style="background-image: url(user/assets/images/hero/hero-slider-two.jpg);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="hero-content text-white">
                    ...
                    <div class="single-slider p-r z-1" data-title="Travel">
                        <div class="image-layer bg_cover" style="background-image: url(user/assets/images/hero/hero-slider-three.jpg);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="hero-content text-white">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="features-thumb-item mb-40 wow fadeInUp">
                            <div class="thumb">
                                <img src="user/assets/images/features/f-1.jpg" alt="Features image">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="features-thumb-item mb-40 wow fadeInUp">
                            <div class="thumb">
                                <img src="user/assets/images/features/f-2.jpg" alt="Features image">
                            </div>
                            <div class="text mt-25">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="features-thumb-item mb-40 wow fadeInUp">
                            <div class="thumb">
                                <img src="user/assets/images/features/f-3.jpg" alt="Features image">
                            </div>
                            <div class="text mt-25">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="features-thumb-item mb-40 wow fadeInUp">
                            <div class="thumb">
                                <img src="user/assets/images/features/f-4.jpg" alt="Features image">
                            </div>
                            <div class="text mt-25">
        ...
        <section class="adventure-bgc-section p-r z-1 pt-15 pb-15">
            ...
            <div class="ad-bg-shape bg_cover wow fadeInRight" style="background-image: url(user/assets/images/bg/ad-bg-1.png);"></div>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="adventure-one_image-box p-r z-1 wow fadeInRight">
                            <img src="user/assets/images/contact/img-1.jpg" class="img-one" alt="Image">
                            <img src="user/assets/images/contact/img-2.jpg" class="img-two" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--====== Start Video Section ======-->
        <section class="video-bg-section pt-140 pb-210 p-r z-1 bg_cover" style="background-image: url(user/assets/images/video/video-1.jpg);">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-service-item mb-30 wow fadeInUp">
                            <div class="img-holder">
                                <img src="user/assets/images/service/service-1.jpg" alt="Service image">
                                <div class="shape"></div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-service-item mb-30 wow fadeInUp">
                            <div class="img-holder">
                                <img src="user/assets/images/service/service-2.jpg" alt="Service image">
                                <div class="shape"></div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-service-item mb-30 wow fadeInUp">
                            <div class="img-holder">
                                <img src="user/assets/images/service/service-3.jpg" alt="Service image">
                                <div class="shape"></div>
                            </div>
                            <div class="text">
        ...
        <section class="choose-bg-section p-r z-1 pt-50 pb-20">
            <div class="choose-bg bg_cover wow fadeInLeft" style="background-image: url(user/assets/images/bg/choose-bg-1.jpg);"></div>
            <div class="container">
        ...
        <section class="cta-section dark-green-bg pt-70 pb-35">
            <div class="container">
                <div class="cta-wrapper bg_cover" style="background-image: url(user/assets/images/bg/cta-bg-1.png);">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                                        ...
                                        <div class="testimonial-content">
                                            <div class="author-title-thumb d-inline-flex">
                                                <div class="author-thumb">
                                                    <img src="user/assets/images/testimonial/author-thumb-1.jpg" alt="Author Thumb">
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-blog-post-item mb-40 wow fadeInUp">
                            <div class="post-thumbnail">
                                <img src="user/assets/images/blog/blog-1.jpg" alt="Blog Image">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-blog-post-item mb-40 wow fadeInUp">
                            <div class="post-thumbnail">
                                <img src="user/assets/images/blog/blog-2.jpg" alt="Blog Image">
                            </div>
                            <div class="entry-content">
                                <div class="post-meta">
                                    <ul>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="single-blog-post-item mb-40 wow fadeInUp">
                            <div class="post-thumbnail">
                                <img src="user/assets/images/blog/blog-3.jpg" alt="Blog Image">
                            </div>
                            <div class="entry-content">
                                <div class="post-meta">
                                    <ul>
